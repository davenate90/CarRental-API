...
class TokensController
{
    ...
    {
        $serverConfig = array('host' => 'apollo.cs.weber.edu',
            'FQDN' => 'cs.weber.edu',
            'accountDomainNameShort' => 'apollo',
            'accountCanonicalForm' => '4',
            'baseDn' => 'dc=cs,dc=weber,dc=edu');
        $ldapConnectionString = 'ldap://apollo.cs.weber.edu:389';
        $ad = ldap_connect($ldapConnectionString) or die("That LDAP-URI was not parseable");;
        if (is_null($ad)) {
